...
const merchantId = "testhdfc1"; //Please input your merchant Id here as shared by Juspay
const clientId = "hdfcmaster"; //Please input your client Id here as shared by Juspay
...
document.getElementById("checkoutButton").addEventListener("click", () => {
  ...
  fetch("http://10.0.2.2:5000/initiateJuspayPayment", requestOptions)
    ...
    .then((result) => {
      ...
      hyperSDKRef.process(result.sdkPayload);
    })
