...
public class JuspayConfig implements ServletContextListener {
    ...
    public static final String SANDBOX_BASE_URL = "https://smartgateway.hdfcuat.bank.in";
    public static final String PRODUCTION_BASE_URL = "https://smartgateway.hdfc.bank.in";
