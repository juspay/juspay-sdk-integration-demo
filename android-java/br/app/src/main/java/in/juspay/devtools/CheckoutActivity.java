package in.juspay.godel.demo.devtools;
...
public class CheckoutActivity extends FragmentActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState, @Nullable PersistableBundle persistentState) {
        ...
        hyperServiceHolder = new HyperServiceHolder(this);
    }
    ...
    public void onBackPressed() {
        boolean handleBackpress = hyperServiceHolder.onBackPressed();
        if(!handleBackpress) {
            super.onBackPressed();
        }
    }
...
//        block:start:onActivityResult
        ...
        if (data != null) {
            hyperServiceHolder.getHyperServices().onActivityResult(requestCode, resultCode, data);
        }
